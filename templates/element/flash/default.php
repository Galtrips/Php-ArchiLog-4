...
<section>
    <div class="alert alert-light d-flex align-items-center" role="alert" style="font-size: 15px; width: fit-content;">
        <i class="bi bi-bookmarks-fill me-2" style="font-size: 15px;"></i>
        <p> - <?= $message ?> </p>
