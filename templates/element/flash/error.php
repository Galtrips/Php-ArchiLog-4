...
<section>
    <div class="alert alert-danger d-flex align-items-center" role="alert" style="font-size: 15px; width: fit-content;">
        <i class="bi bi-bug-fill me-2" style="font-size: 15px;"></i>
        <p> - <?= $message ?> </p>
